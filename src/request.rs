...
use crate::method::Meth;
use crate::prelude::*;
use crate::{Id, Method, Version};
use cosmrs::rpc::dialect::{Dialect, LatestDialect};
use cosmrs::rpc::Error;

/// Serialization for JSON-RPC requests
pub trait RequestMessage<M>: DeserializeOwned + Serialize + Sized {
    /// Request method
    fn method(&self) -> M;
...
pub trait SimpleRequest<M: Meth, S: Dialect = LatestDialect>: Request<M, S> {
